...
public:
    ...
    bool Player_overlapWith_VaccineGoodies(double goodies_x, double goodies_y);
    bool Player_overlapWith_GasCanGoodies(double goodies_x, double goodies_y);
    bool Player_overlapWith_LandmineGoodies(double goodies_x, double goodies_y);
